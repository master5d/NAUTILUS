...
<div align="center">
  <img src="../images/knowledge-graph.svg" alt="Semantic Graph Pipeline" style="width: 100%; max-width: 800px; background: #0b0f19; border: 1px solid #1e293b; border-radius: 12px; box-shadow: 0 10px 30px rgba(0,0,0,0.5);" />
</div>
